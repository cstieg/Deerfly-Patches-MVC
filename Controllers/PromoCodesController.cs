...
namespace Deerfly_Patches.Controllers
{
    public class PromoCodesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Code,Description,PromotionalItemPrice,MinimumQualifyingPurchase,PercentOffItem,PercentOffOrder,SpecialPrice,CodeStart,CodeEnd")] PromoCode promoCode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Code,Description,PromotionalItemPrice,MinimumQualifyingPurchase,PercentOffItem,PercentOffOrder,SpecialPrice,CodeStart,CodeEnd")] PromoCode promoCode)
        {
            if (ModelState.IsValid)
            {
